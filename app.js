  ...
  return (
    <div className="container">
      ...
      <div className="card">
        ...
        <label>Sentiment au moment du repas (optionnel)</label>
        ...
        />
        <button className="secondary" onClick={addIngredient}>Ajouter l’ingrédient</button>

        <ul>
          {mealIngredients.map(i => (
            <li key={i.key}>
              {i.label}
              <button onClick={() => removeIngredient(i.key)}>✕</button>
            </li>
          ))}
        </ul>
